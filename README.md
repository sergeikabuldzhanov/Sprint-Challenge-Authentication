...
- [x] What is the purpose of using _sessions_?
    ...
    Sessions are used to save information about the state of a particular user, we need them since HTTP protocol is stateless by default.

- [x] What does bcrypt do to help us store passwords in a secure manner.

    Bcrypt hashes the password and makes it more difficult for attackers to use in case the password leaks.

- [x] What does bcrypt do to slow down attackers?

    Uses a random salt for each hashed password
